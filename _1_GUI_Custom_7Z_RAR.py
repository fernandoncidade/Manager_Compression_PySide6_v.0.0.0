...
from _2_gerente_GUI_layouts_7Z_RAR import GerenciadorInterface
from _3_metodos_compressao_7Z_RAR import MetodoCompressao
from _5_colors import (change_theme, apply_neutral_standart_theme, apply_light_theme,
