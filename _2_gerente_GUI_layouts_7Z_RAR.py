...
from _4_motores_compressao_7Z_RAR import (buscar_sevenzip_executavel, buscar_winrar_executavel,
                                          CompressaoRAR, CompressaoZIP, Compressao7Z,
                                          CompressaoTAR, TestarIntegridade, Extracao)
from _5_colors import apply_dialog_box_theme, apply_message_box_theme
